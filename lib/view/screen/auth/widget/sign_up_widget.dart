...
import 'package:flutter_sixvalley_ecommerce/view/screen/support/issue_type_screen.dart';
      ...
      children: [
        ...
        Row(
          children: [
            ...
            Text.rich(TextSpan(
                text: getTranslated('I_agree_to_the', context),
                children: <InlineSpan>[
                  TextSpan(
                  ...
                  TextSpan(
                      text: getTranslated('and_Terms_of_Use', context),
                      recognizer: new TapGestureRecognizer()
                        ..onTap = () => {
                              Navigator.push(
                                  context,
